...
def manuscript_text(results: dict, word_count: int = 0) -> list[tuple[str, str]]:
    ...
    threshold_paragraph = (
        ...
        + ". The selected 0.08 threshold therefore retained a safety margin without escalating more than one third of the cohort."
    )
    return [
